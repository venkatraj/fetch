...
function fetch_setup() { 
	 ...
	 */
	$GLOBALS['content_width'] = apply_filters( 'fetch_content_width', 640 );
    ...
    */
	...
	$starter_content = array(
		'widgets' => array(
			...
			'footer-3' => array(
			    ...
			    'my_text' => array(
		        	...
		        	// Widget $instance -> settings 
					array(
					  'text'  => __('<ul><li><i class="fa fa-map-marker"></i> Twenty Four Lanem Moama NSW 2731 info@uniq.com.au</li><li><i class="fa fa-envelope"></i> info@gmail.com</li><li><i class="fa fa-phone"></i> +123 456 7890</li><li><i class="fa fa-fax"></i> 03 5481 2221</li></ul>','fetch'),
					)
				)
			),
		),
		...
		'attachments' => array(
			...
			'page-images3' => array(
				'post_title' => __( 'Page Images', 'fetch' ),
				'file' => 'images/pb-3.png', // URL relative to the template directory.
			),
		),
...
add_action( 'wp_head', 'fetch_remove_wc_breadcrumbs' );
